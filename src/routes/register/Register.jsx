    ...
    <>
      <div>
        ...
        <div className="register__already">
          ...
          <Link className="register__already-link" to={"/signIn"}>Sign in</Link>
        </div >
        <div className="register__container">
          <h2 className="register__create">Create an account</h2>
          <div className="register__create-wrapper">
          <form className="register__createUser-wrapper" onSubmit={createUser}>
            ...
            className="register__createUser-email"
              ...
              minLength={8}
            />
            <p className="register__createUser-par">By <span className="register__createUser-span">Creating an account</span>, you agree to our <span className="register__createUser-line">User Agreement</span>  and acknowledge reading our <span className="register__createUser-line">User Privacy Notice .</span></p>
            <button className="register__createUser-btn" type="submit">Create account</button>
          </form>
          <div className="register__googlelink-wrapper">
            <span className="register__googlelink-span"><Link className="register__googlelink" to={"https://accounts.google.com/v3/signin/identifier?dsh=S-1157271442%3A1677654654829000&continue=https%3A%2F%2Fwww.google.com%3Fhl%3Dru&ec=GAlA8wE&hl=ru&flowName=GlifWebSignIn&flowEntry=AddSession"}><FcGoogle/>   Continue with Google</Link></span>
            or
